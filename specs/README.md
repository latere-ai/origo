...
| [002](002-repository-scaffold.md) | Repository scaffold: module, binary, configuration, gate, release | small | in-progress |
| [003](003-protocol-contract.md) | Protocol contract: what a consumer relies on | medium | validated |
| [004](004-write-ahead-log.md) | Write-ahead log: entries, immutable index, create-if-absent commit, materialization | large | validated |

...
| [005](005-placement-and-replication.md) | Placement and replication: rendezvous hashing, gossip, consistent reads, cache eviction | medium | testing |
...
| 3 | 005, 006, 008, 009 | Many nodes with consistent reads, compaction under load, push events, the read API and archive | 008 complete; 005 and 009 built, at testing until 013's jobs prove their cluster criteria and the 40 second fuzz; 006 next |
| 4 | 010, 011, 012, 015 | LFS, telemetry, limits, and degraded-storage behaviour | 010 complete, the 500 MiB round trip green in the `e2e-slow` job; 011, 012, 015 next |
